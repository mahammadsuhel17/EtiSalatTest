...
class BlockViewController: UIViewController {
    ...
    var Button = CustomButton(hasBackground: true, title: "Ok, got it", buttonType: .big )
    ...
    func configureScreenImage (){
        ...
        screenImage.image = UIImage(named: "blockScreenImage")
    ...
    func configureBodyText (){
        ...
        bodyText.text = "Your request has been blocked to ensure your protection.  "
